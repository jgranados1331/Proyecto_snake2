...
class Configuraciones(object):
    def __init__(self):
        ...
        self.reloj = pygame.image.load("Images/hora.png")
        self.poop = pygame.image.load("Images/poo.png")
        self.select_food=random.randint(0,8)
        self.select_food2=random.randint(0,8)
